...
import { MapPin, X, Clock, DollarSign, Calendar, Navigation, CheckCircle2, User } from "lucide-react";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
const ClinicDetails = () => {
  ...
  return (
    <div className="w-full min-h-screen">
            ...
            {selectedCabinet.specialities?.length > 0 ? (
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-4 lg:grid-cols-12">
                {selectedCabinet.specialities.map((speciality, index) => (
                  <div
                    key={index}
                    className="items-center justify-center gap-3 p-3 transition-all duration-200 border border-blue-300 rounded-lg hover:shadow-sm group"
                  >
     ...
     {/* Doctors Section */}
        <div className="mb-12">
          <h6 className="mb-4 text-xl font-bold text-gray-900">
            Our Doctors
          </h6>
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="relative">
                      ...
                      />
                    {doctor.is_active &&( <div className="absolute w-4 h-4 bg-green-500 border-2 border-white rounded-full -bottom-1 -right-1"></div>)}
                    </div>
                    ...
                    {(doctor.start_time || doctor.end_time) && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600">
                         From <span className="font-bold">{doctor.start_time || "N/A"}</span>  To  <span className="font-bold">{doctor.end_time || "N/A"}</span>
                        </span>
                      </div>
                    )}
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-4">
              <h6 className="text-xl font-bold text-gray-900">Where you we'll be</h6>
              {isValidLatLng && (
                <a
