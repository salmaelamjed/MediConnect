import Card08, { type DoctorCardProps } from "./doctor-card"

interface CardGrid {
  items: DoctorCardProps[]
  gridTitle?: string
}

const collections: DoctorCardProps[] = [
  {
  ...
  return (
    <section className="w-full py-12 md:py-16 lg:py-20">
      <div className="container px-4 mx-auto md:px-6">
        {gridTitle && (
          <h2 className="mb-2 text-3xl font-bold tracking-tighter text-left text-zinc-900 dark:text-zinc-100 sm:text-4xl">
            {gridTitle}
          </h2>
        )}
        <p className="mb-8 text-lg tracking-tight text-left text-zinc-900 dark:text-zinc-100">
