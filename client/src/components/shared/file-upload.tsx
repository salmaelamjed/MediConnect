    ...
    return (
        ...
        >
            <div className="group relative w-full rounded-xl bg-white  ring-1 ring-gray-200  p-0.5">
                <div className="absolute inset-x-0 w-full h-px -top-px bg-gradient-to-r from-transparent via-blue-300/20 to-transparent" />
                ...
                <div className="relative w-full rounded-[10px] bg-gray-50/50 p-1.5">
                    ...
                    >
                        ...
                        <div className="absolute w-8 h-8 transition-opacity duration-500 opacity-0 -right-4 -top-4 bg-gradient-to-br from-blue-500/20 to-transparent blur-md group-hover:opacity-100" />
                        ...
                        <AnimatePresence>
                            {error && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -10 }}
                                    className="absolute px-4 py-2 transform -translate-x-1/2 border rounded-lg bottom-4 left-1/2 bg-red-500/10 border-red-500/20"
                                >
